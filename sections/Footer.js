      ...
      <footer className='section'>
         <div className='wrapper flex flex-col gap-12'>
            <nav className='flex flex-col md:flex-row gap-5 justify-between items-center'>
               <ul className='flex text-sm md:text-md gap-3 md:gap-5'>
            ...
            <span className="font-bold text-3xl tracking-tight text-primary-light font-kumbh-sans text-center"><span className='font-alata font-medium'>$</span> f.dev</span>
