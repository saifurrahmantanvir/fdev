   ...
   return (
      <div className='flex flex-col w-40 min-w-[10rem] md:w-60 md:min-w-[15rem] lg:w-80 lg:min-w-[20rem] gap-8 md:gap-12'>
         ...
         <div className='flex flex-col gap-2 md:gap-4'>
            ...
            <p className='text-gray-500 text-sm md:text-md lg:text-lg block tracking-tight'>How to get start with open source contribution How to get start with open source contribution</p>
