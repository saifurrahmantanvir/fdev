...
const HeroContent = () => {
   return (
      <div className="col-span-1 md:col-start-2 md:col-span-6 flex flex-col justify-between gap-4 mt-10">
         <h1 className="font-kumbh-sans text-primary-light uppercase text-2xl md:text-2xl lg:text-4xl font-semibold tracking-tight md:whitespace-nowrap">Read next level blogs here</h1>
